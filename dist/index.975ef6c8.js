...
var _allBooksMarkup = require("./js/allBooksMarkup");
var _bestsellers = require("./js/bestsellers");
var _fetchBooks = require("./js/fetchBooks");
var _fetchSelectedBooksJs = require("./js/fetchSelectedBooks.js");
var _oneBookMarkup = require("./js/oneBookMarkup");
var _refs = require("./js/refs");
var _renderMainTitle = require("./js/render-main-title");
var _renderSelectedCategory = require("./js/renderSelectedCategory");
var _seeMoreJs = require("./js/seeMore.js"); // import './js/header-height-adjust.js';
...
},{"./js/seeMore.js":"6uCRw","./js/renderSelectedCategory":"7g2CF","./js/render-main-title":"fFUz9","./js/refs":"2WoF2","./js/oneBookMarkup":"4c98k","./js/fetchSelectedBooks.js":"6Gzff","./js/fetchBooks":"f9G4Q","./js/bestsellers":"ekeeW","./js/allBooksMarkup":"edB1A"}],"6uCRw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _refs = require("./refs");
var _refsDefault = parcelHelpers.interopDefault(_refs);
var _fetchSelectedBooks = require("./fetchSelectedBooks");
var _renderSelectedCategory = require("./renderSelectedCategory");
var _backToTop = require("./back-to-top");
var _renderMainTitle = require("./render-main-title");
const { categoryContainerEl  } = (0, _refsDefault.default)();
...
async function seeMoreBtnClickHandler(e) {
    ...
    const data = await (0, _fetchSelectedBooks.fetchSelectedBooks)(id);
    (0, _renderMainTitle.renderMainTitle)(id);
    const categoriesBtn = document.querySelectorAll(".category-btn");
    const activeCategoryBtn = document.querySelector(".active-category");
    for (const btn of categoriesBtn)if (btn.dataset.id === id) btn.classList.add("active-category");
    activeCategoryBtn.classList.remove("active-category");
    (0, _renderSelectedCategory.renderBooksByCategory)(data);
    (0, _backToTop.scrollToTop)();
}

},{"./refs":"2WoF2","./fetchSelectedBooks":"6Gzff","./renderSelectedCategory":"7g2CF","./back-to-top":"hIZlk","./render-main-title":"fFUz9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2WoF2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"6Gzff":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchSelectedBooks", ()=>fetchSelectedBooks);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
async function fetchSelectedBooks(category1) {
    (0, _notiflixDefault.default).Loading.dots("Please wait");
    ...
    try {
        const { data  } = await (0, _axiosDefault.default).get(`https://books-backend.p.goit.global/books/category?category=${category1}`);
        (0, _notiflixDefault.default).Loading.remove();
        return data;
    } catch (error) {
        (0, _notiflixDefault.default).Loading.remove();
        (0, _notiflixDefault.default).Notify.failure("Something went wrong. Please try again");
        console.log(error);
    }
}
...
},{}],"7g2CF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderBooksByCategory", ()=>renderBooksByCategory);
var _refs = require("./refs");
var _refsDefault = parcelHelpers.interopDefault(_refs);
var _allBooksMarkup = require("./allBooksMarkup");
const { renderingContainer  } = (0, _refsDefault.default)();
function renderBooksByCategory(data) {
    const markup = (0, _allBooksMarkup.makeCategoryBooksMarkup)(data);
    renderingContainer.innerHTML = markup;
}

},{"./refs":"2WoF2","./allBooksMarkup":"edB1A","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"edB1A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeCategoryBooksMarkup", ()=>makeCategoryBooksMarkup);
var _oneBookMarkup = require("./oneBookMarkup");
      ...
      <ul class="category-books-list">
        ...
        return `
            <li class="books-list-item">
              ${(0, _oneBookMarkup.createBookMarkup)(element)}
            </li>
          `;
    }).join("")}
      </ul>
...
},{"./oneBookMarkup":"4c98k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4c98k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createBookMarkup", ()=>createBookMarkup);
function createBookMarkup({ _id: id , title , author , description , // list_name,
book_image: image ,  }) {
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hIZlk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toTopObserver", ()=>toTopObserver);
parcelHelpers.export(exports, "scrollToTop", ()=>scrollToTop);
var _refs = require("./refs");
var _refsDefault = parcelHelpers.interopDefault(_refs);
const { scrollToTopButton , toTopTarget  } = (0, _refsDefault.default)();
const toTopObserver = new IntersectionObserver(cb);
function cb(entries) {
...
},{"./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fFUz9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMainTitle", ()=>renderMainTitle);
var _refs = require("./refs");
var _refsDefault = parcelHelpers.interopDefault(_refs);
...
},{"./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f9G4Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
async function getTopBooksArray() {
    (0, _notiflixDefault.default).Loading.dots();
...
exports.default = getTopBooksArray;

},{"notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ekeeW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Fetch and render bestsellers:
parcelHelpers.export(exports, "renderTopBooks", ()=>renderTopBooks);
var _fetchBooks = require("./fetchBooks");
var _fetchBooksDefault = parcelHelpers.interopDefault(_fetchBooks);
var _oneBookMarkup = require("./oneBookMarkup");
var _refsJs = require("./refs.js");
var _refsJsDefault = parcelHelpers.interopDefault(_refsJs);
const { renderingContainer  } = (0, _refsJsDefault.default)();
async function renderTopBooks() {
    ...
    else // ...otherwise fetch data from server
    try {
        data = await (0, _fetchBooksDefault.default)();
          ...
          <ul class="books-list">
            ${books.map((book)=>`
              <li class="books-list-item bestsellers-book-item">
                ${(0, _oneBookMarkup.createBookMarkup)(book)}
              </li>
            `).join("")}
          </ul>
...
},{"./fetchBooks":"f9G4Q","./oneBookMarkup":"4c98k","./refs.js":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
